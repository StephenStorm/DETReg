...
# stephen add , for tianchi fewshot trademark detection 
def build_trademark(image_set, args):
    ...
    # mode = 'instances'
    PATHS = {
        "train": (root / "train" / "images", root / "train" / "annotations" / 'train.json'),
        "val": (root / "train" / "images", root / "val" / "annotations" / 'val.json'),
    }
